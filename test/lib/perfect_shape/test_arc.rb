...
describe PerfectShape do
  describe PerfectShape::Arc do
    ...
    it 'returns path shapes as an chord type arc that is between three quarter and full ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 6
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[5].points[0][0].to_i).must_equal 500
      _(shape.to_path_shapes[5].points[0][1].to_i).must_equal 350
    end
    ...
    it 'returns path shapes as an chord type arc that is three quarters of an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 5
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[4].points[0][0].to_i).must_equal 500
      _(shape.to_path_shapes[4].points[0][1].to_i).must_equal 350
    end
    ...
    it 'returns path shapes as an chord type arc that is half an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 4
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[3].points[0][0].to_i).must_equal 500
      _(shape.to_path_shapes[3].points[0][1].to_i).must_equal 350
    end
    ...
    it 'returns path shapes as an chord type arc that is one quarter of an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 3
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[2].points[0][0].to_i).must_equal 500
      _(shape.to_path_shapes[2].points[0][1].to_i).must_equal 350
    end
    ...
    it 'returns path shapes as an chord type arc that has a start and extent of 0 (angle of 0)' do
      ...
      _(shape.to_path_shapes.count).must_equal 2
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::Line]

      _(shape.to_path_shapes[0].x).must_equal 500.0
      _(shape.to_path_shapes[0].y).must_equal 350.0

      _(shape.to_path_shapes[1].points[0][0]).must_equal 500.0
      _(shape.to_path_shapes[1].points[0][1]).must_equal 350.0
    end
    ...
    it 'returns path shapes as an pie type arc that is between three quarter and full ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 7
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[5].points[0][0].to_i).must_equal 400
      _(shape.to_path_shapes[5].points[0][1].to_i).must_equal 350

      _(shape.to_path_shapes[6].points[0][0].to_i).must_equal 500
      _(shape.to_path_shapes[6].points[0][1].to_i).must_equal 350
    end
    ...
    it 'returns path shapes as an pie type arc that is three quarters of an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 6
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[4].points[0][0].to_i).must_equal 400
      _(shape.to_path_shapes[4].points[0][1].to_i).must_equal 350
    ...
    it 'returns path shapes as an pie type arc that is half an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 5
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::CubicBezierCurve, PerfectShape::Line, PerfectShape::Line]
      ...
      _(shape.to_path_shapes[3].points[0][0].to_i).must_equal 400
      _(shape.to_path_shapes[3].points[0][1].to_i).must_equal 350
    ...
    it 'returns path shapes as an pie type arc that is one quarter of an ellipse' do
      ...
      _(shape.to_path_shapes.count).must_equal 4
      _(shape.to_path_shapes.map(&:class)).must_equal [PerfectShape::Point, PerfectShape::CubicBezierCurve, PerfectShape::Line, PerfectShape::Line]
